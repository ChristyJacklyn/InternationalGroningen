        ...
        <div className='flex flex-col'>
            <div className='flex justify-end items-end'>
                <div className="secondgridcontainer p-3 bg-blue-100">
                    <div className="div lg:p-4"><img src={image} alt={title} className='buinessimage1 rounded-xl' style={{height:'500px',width:'500px'}}/></div>
                    <div className="flex flex-col text-xl m-3 lg:p-10 ">
