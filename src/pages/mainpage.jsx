        ...
        <div className="flex flex-col">
            ...
            <div className="flex lg:flex-row md:flex-row flex-col">
                ...
                <div className="beforeyoumovegrid grid grid-cols-3 grid-rows-3 gap-2 p-4 ">
                        ...
                        <div className="relative beforemovegrid"><img src={studentgroup} className="beforyoumoveimage w-full h-full object-cover"/><div className="gridarrow w-full absolute bottom-10 left-10" style={{fontSize:'30px',color:'white',fontWeight:'bold'}}> Student Housing&#8594;</div></div>
                        <div className="relative beforemovegrid "><img src={group} className="beforyoumoveimage w-full h-full object-cover" /><div className="gridarrow w-full absolute bottom-10 left-10" style={{fontSize:'30px',color:'white',fontWeight:'bold'}}>Job Opportunity &#8594;</div></div>
                        <div className="relative beforemovegrid row-span-2"><img src={house2} className="beforyoumoveimage w-full h-full object-cover"/><div className="gridarrow w-full absolute bottom-10 left-10" style={{fontSize:'30px',color:'white',fontWeight:'bold'}}>City &#8594;</div></div>
                        <div className="relative beforemovegrid "><img src={pondhouse} className="beforyoumoveimage w-full h-full object-cover"/><div className="gridarrow w-full absolute bottom-10 left-10" style={{fontSize:'30px',color:'white',fontWeight:'bold'}}>Business Possibilities &#8594;</div></div>
                        ...
                        <div className="relative beforemovegrid"><img src={house3} className="beforyoumoveimage w-full h-full object-cover"/><div className="gridarrow absolute w-full bottom-10 left-10" style={{fontSize:'30px',color:'white',fontWeight:'bold'}}> &#8594;</div></div>           
